...
ALTER TABLE team_names ADD CONSTRAINT non_overlap_team_name_timespan EXCLUDE USING gist (team_id WITH =, timespan WITH &&);
ALTER TABLE player_names ADD CONSTRAINT non_overlap_player_name_timespan EXCLUDE USING gist (player_id WITH =, timespan WITH &&);
ALTER TABLE player_positions ADD CONSTRAINT non_overlap_player_position_timespan EXCLUDE USING gist (player_id WITH =, timespan WITH &&);
ALTER TABLE team_players ADD CONSTRAINT non_overlap_team_player_timespan EXCLUDE USING gist (player_id WITH =, timespan WITH &&);
